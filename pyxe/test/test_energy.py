...
data = create_intensity_array(i12_energy, pnts=(7, 7), max_strain=1e-3)
data_dict,(e_xx, e_yy, e_xy) = data

q0 = create_intensity_array(i12_energy, pnts=(1, 1), max_strain=0)
q0_data_dict, _ = q0
